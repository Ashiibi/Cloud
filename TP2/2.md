...
```
```
> az vm create -g MurkyDivers -n tp2 --image Ubuntu2204 --admin-username ashiibi --ssh-key-values "C:\Users\sacha\.ssh\id_rsa.pub" --custom-data "C:\Users\sacha\OneDrive\Documents\cloud-init.txt"

{
  ...
  "location": "westeurope",
  "macAddress": "7C-ED-8D-12-42-20",
  "powerState": "VM running",
  "privateIpAddress": "10.0.0.4",
  "publicIpAddress": "20.61.209.59",
  "resourceGroup": "MurkyDivers",
  "zones": ""
}
```
