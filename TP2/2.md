...
```
```
> az vm create -g MurkyDivers -n tp2 --image Ubuntu2204 --admin-username ashiibi --ssh-key-values "C:\Users\sacha\.ssh\id_rsa.pub" --custom-data ""C:\Users\sacha\Downloads\cloud-init.txt""
